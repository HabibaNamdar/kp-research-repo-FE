  ...
  const publications = [
    {
      ...
      desc: "This paper explores the role of deep learning techniques in medical imaging and diagnostic processes.",
    },
    {
      img: "/pub2.jpg",
      title: "Advances in Robotics Surgery Techniques",
      ...
      desc: "An analysis of robotic surgery advancements using AI and machine vision.",
    },
    {
      img: "/pub3.jpg",
      title: "Improving Access to Healthcare Through AI",
      ...
      desc: "A discussion on how AI can improve patient access and medical data processing.",
    },
    {
      img: "/pub4.jpg",
      title: "Water and Air Quality Monitoring",
      ...
      desc: "Monitoring environmental quality using AI-enabled IoT sensors.",
    },
    {
      img: "/pub5.jpg",
      title: "AI in Agriculture and Crop Prediction",
      author: "Dr. Ahmed Ali",
      tags: ["AI", "ML"],
      year: "2024",
      category: "Agriculture",
      desc: "Using machine learning for smarter crop yield prediction and resource optimization.",
    },
    {
      img: "/pub6.jpg",
      title: "Smart City Data Analytics",
      author: "Dr. Ahmed Ali",
      tags: ["Data Analytics", "Smart Systems"],
      year: "2025",
      category: "Urban Development",
      desc: "Analyzing large-scale urban datasets to improve city infrastructure and planning.",
    },
  ];

  const handleViewDetails = (pub: any) => {
    navigate("/featured", { state: pub }); // 👈 pass selected publication data
  };
